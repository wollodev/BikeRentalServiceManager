package de.rwth.idsg.brsm.config.reload;

import de.rwth.idsg.brsm.config.reload.reloader.JacksonReloader;
import de.rwth.idsg.brsm.config.reload.reloader.LiquibaseReloader;
import de.rwth.idsg.brsm.config.reload.reloader.SpringReloader;
    ...
    public void reloadEvent(String typename, Class<?> clazz) {
        synchronized (lock) {
            ...
            if (AnnotationUtils.findAnnotation(clazz, Repository.class) != null ||
                ...
                startReloading = true;
            } else if (typename.startsWith("de.rwth.idsg.brsm.domain")) {
            ...
            } else if (typename.startsWith("de.rwth.idsg.brsm.web.rest.dto")) {
