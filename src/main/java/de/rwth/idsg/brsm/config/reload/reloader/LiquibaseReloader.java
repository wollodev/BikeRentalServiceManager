...
import de.rwth.idsg.brsm.config.reload.instrument.hibernate.JHipsterEntityManagerFactoryWrapper;
...
public class LiquibaseReloader {
    ...
    public void reloadEvent(List<Class> entities) {
        ...
        try {
            final String packagesToScan = "de.rwth.idsg.brsm.domain";
    ...
    private Database getDatabaseSource() {
        return new liquibase.database.core.PostgresDatabase();
    }
