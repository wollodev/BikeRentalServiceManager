...
public class UserService {
    ...
    public boolean createLender(UserRegistrationDTO user) {
        User newUser = new User();
        newUser.setFirstName(user.getFirstName());
        newUser.setLastName(user.getLastName());
        newUser.setLogin(user.getLogin().toLowerCase());
        ...
        Authority managerAuthority = authorityRepository.findOne(AuthoritiesConstants.MANAGER);

        if (!currentUser.getAuthorities().contains(managerAuthority)) {
            return false;
        }
